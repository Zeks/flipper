...
App{
    ...
    files: [
        ...
        "src/storyfilter.cpp",
        "src/web/url_utils.cpp",
        "src/rng.cpp",
        "include/rng.h",
        "src/transaction.cpp",
        "include/transaction.h",
        "src/web/pagetask.cpp",
        ...
        "src/app/server/rec_calculation_wrapper.cpp",
        ...
        "include/web/page_utils.h",
        "include/web/pageconsumer.h",
        "src/web/pageconsumer.cpp",
        "src/web/page_utils.cpp",

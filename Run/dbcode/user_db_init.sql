...
INSERT INTO fandom_lists(id, name, is_enabled, is_default, is_expanded, ui_index) values(0, 'Ignores',   1, 1, 1, 0);
INSERT INTO fandom_lists(id, name, is_enabled, is_default, is_expanded, ui_index) values(1, 'Whitelist', 1, 1, 1, 1);

...
SleepyDiscord::Embed GetTopLevelHelpPage(std::string_view serverPrefix)
{
    ...
    supportText  +="\nIf you want to support the bot's development and hosting you can do it on [Patreon](https://www.patreon.com/zekses)";
    supportText  +="\nIf you want to add this bot to your server use this [link](https://discord.com/api/oauth2/authorize?client_id=742050608235937916&permissions=337984&scope=bot)";
